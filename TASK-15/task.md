...
KKE_TABLE_NAME: name of the DynamoDB table<br>
KKE_ROLE_NAME: name of the IAM role<br>
KKE_POLICY_NAME: name of the IAM policy<br>
Create the outputs.tf file with the following outputs:<br>

kke_dynamodb_table: name of the DynamoDB table<br>
kke_iam_role_name: name of the IAM role<br>
kke_iam_policy_name: name of the IAM policy<br>
