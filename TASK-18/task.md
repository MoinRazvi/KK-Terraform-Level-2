...
Metric: CPU Utilization<br>
Threshold: >= 90% for 1 consecutive 5-minute period<br>
Alarm Actions: Send a notification to the datacenter-sns-topic SNS topic.<br>
Update the main.tf file (do not create a separate .tf file) to create a EC2 Instance and CloudWatch Alarm.<br>

Create an outputs.tf file to output the following values:

KKE_instance_name for the EC2 instance name.<br>
KKE_alarm_name for the CloudWatch alarm name.<br>
