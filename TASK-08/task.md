...
Create a New Private S3 Bucket: Name the bucket nautilus-sync-1158 and store this bucket name in a variable named KKE_BUCKET.

Data Migration: Migrate all data from the existing nautilus-s3-24453 bucket to the new nautilus-sync-1158 bucket.
