...
Use a local-exec provisioner with the IAM user resource to log the message KKE iamuser_kirsty has been created successfully! to a file called KKE_user_created.log under home/bob/terraform.
...
KKE_USER_NAME: name of the IAM user.<br>
Use terraform.tfvars to input the name of the IAM user.<br>
