...
KKE_VPC_CIDR for the VPC CIDR block.<br>
KKE_SUBNET_CIDR for the subnet CIDR block.<br>
Use the outputs.tf file with the following variable names:<br>

KKE_vpc_name for the name of the VPC.<br>
KKE_subnet_name for the name of the subnet.<br>
KKE_ec2_private for the name of the EC2 instance.<br>
